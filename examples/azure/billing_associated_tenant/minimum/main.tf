...
module "root" {
  ...
  azure_billing_associated_tenants = {
    partner = {
      ...
      tenant_id                     = var.associated_tenant_id
      display_name                  = var.display_name
      billing_management_state      = var.billing_management_state
      provisioning_management_state = var.provisioning_management_state
    }
  }
}
