...
variable "private_link_scope_name" {
  type        = string
  description = "The name of the Azure Monitor Private Link Scope to link to."
}

variable "scoped_resource_name" {
  type        = string
  description = "The name of the scoped resource association."
}

variable "linked_resource_id" {
  type        = string
  description = "The ARM resource ID of the Azure Monitor resource to link (Log Analytics Workspace, Data Collection Endpoint, Monitor Workspace)."
}
