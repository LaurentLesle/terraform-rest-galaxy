...
| <a name="input_plaintext_value"></a> [plaintext\_value](#input\_plaintext\_value) | The secret value in plain text. It will be encrypted with the environment's public key before upload. | `string` | n/a | yes |
| <a name="input_repo"></a> [repo](#input\_repo) | The repository name (without .git extension). | `string` | n/a | yes |
| <a name="input_secret_name"></a> [secret\_name](#input\_secret\_name) | The name of the environment-scoped Actions secret (e.g. API\_KEY). | `string` | n/a | yes |
...
| <a name="output_name"></a> [name](#output\_name) | The name of the environment-scoped Actions secret. |
