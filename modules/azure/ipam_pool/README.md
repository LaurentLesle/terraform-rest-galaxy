...
| Name | Type |
| ---- | ---- |
| [rest_resource.ipam_pool](https://registry.terraform.io/providers/LaurentLesle/rest/1.2.0/docs/resources/resource) | resource |
...
| ---- | ----------- | ---- | ------- | :------: |
| <a name="input_address_prefixes"></a> [address\_prefixes](#input\_address\_prefixes) | List of IP address prefixes for the pool. | `list(string)` | n/a | yes |
...
| <a name="input_description"></a> [description](#input\_description) | A description of the IPAM pool. | `string` | `null` | no |
| <a name="input_display_name"></a> [display\_name](#input\_display\_name) | A friendly display name for the pool. | `string` | `null` | no |
...
| <a name="input_parent_pool_name"></a> [parent\_pool\_name](#input\_parent\_pool\_name) | The name of the parent pool. Empty or null for root pools. | `string` | `null` | no |
| <a name="input_pool_name"></a> [pool\_name](#input\_pool\_name) | The name of the IPAM pool. | `string` | n/a | yes |
...
| Name | Description |
| ---- | ----------- |
| <a name="output_id"></a> [id](#output\_id) | The full ARM resource ID of the IPAM pool. |
| <a name="output_location"></a> [location](#output\_location) | The location of the IPAM pool. |
| <a name="output_name"></a> [name](#output\_name) | The name of the IPAM pool. |
